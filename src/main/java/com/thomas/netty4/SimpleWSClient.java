...
public final class SimpleWSClient {
    ...
    public static void sayHello(List<Channel> channels) throws Exception {
    	Thread.sleep(3000L);
    	Date date = new Date();
    	String dateStr = DateFormatUtils.format(date, "kk:mm:ss:SSS");
    	for(int i = 0; i < SIZE; i ++) {
    		Channel ch = channels.get(i);
    		String msg = String.format("connection %1s : %2s", i, dateStr); 
    		WebSocketFrame frame = new TextWebSocketFrame(msg);
            ch.writeAndFlush(frame);
    	}
    }
    
    public static void readInput(Channel ch) throws Exception {
